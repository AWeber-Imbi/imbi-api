...
class LoginPasswordRehashTestCase(unittest.TestCase):
    ...
    def test_login_with_password_rehash(self) -> None:
        ...
        with (
            mock.patch(
                'imbi_common.age.run', side_effect=mock_run_side_effect
            ),
...
class LoginMFATestCase(unittest.TestCase):
    ...
    def test_login_oauth_only_user(self) -> None:
        ...
        with (
            ...
            mock.patch('imbi_common.age.fetch_node', return_value=oauth_user),
        ):
            response = self.client.post(
                '/auth/login',
...
class OAuthCallbackSuccessTestCase(unittest.TestCase):
    ...
    def test_oauth_callback_success_existing_identity(self) -> None:
        ...
        with (
            ...
            mock.patch(
                'imbi_common.age.fetch_node', return_value=test_identity
            ),
            mock.patch('imbi_common.age.refresh_relationship') as mock_refresh,
            mock.patch('imbi_common.age.create_node'),
    ...
    def test_oauth_callback_success_new_user(self) -> None:
        ...
        with (
            ...
            mock.patch('imbi_common.age.create_relationship'),
            mock.patch('imbi_common.age.refresh_relationship') as mock_refresh,
            mock.patch('imbi_common.age.upsert'),
        ):
...
class TokenRefreshTestCase(unittest.TestCase):
    ...
    def test_refresh_token_revoked(self) -> None:
        ...
        with (
            ...
            mock.patch('imbi_common.age.fetch_node', return_value=token_meta),
        ):
            response = self.client.post(
                '/auth/token/refresh',
                json={'refresh_token': refresh_token},
